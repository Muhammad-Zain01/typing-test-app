const data = [
    ...
    'He took one look at what was under the table and noped the hell out of there.It was the scarcity that fueled his creativity.He shaved the peach to prove a point.',
]
